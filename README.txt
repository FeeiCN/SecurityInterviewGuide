...
4.2.  不同层次能力要求
   ...
   *  P8（高级专家），校招不可能到达此层级，社招一般10年以上工作经验。一般为该行业综合能力极强的人。工作职责上一般会负责某个大方向或领域，实线带领团队，体系化建设，深度广度都有较高，以体为主。

   *  P9（资深专家），已经不看年限了，不是努力就能达到的位置。一般为该行业技术能力最顶尖的人，工作职责上一般为大厂某条业务线安全负责人或某个大方向安全负责人。行业内大家耳熟能详的人大都处于P8和P9之间，比如猪猪侠。

   *  P10（研究员），已经不看年限了，不是努力就能达到的位置。一般为这个行业综合能力最出色的人（个位数），比如前端的玉伯、云计算的褚霸、安全的道哥。
...
8.  安全面试经验
   ...
   8.2.  面试过程经验
      ...
      8.2.2.  面试过程
         ...
         - 使用专业面试法。学习了解STAR面试法、行为面试法，能让我们更加清楚的描述做过的事情。避免使用大概、好像、很多等模糊字眼。
